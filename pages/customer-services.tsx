  ...
  return (
    <div className='max-w-[1000px] pb-3'>
      <h1 className='my-3 font-bold text-xl'>
        Customer Service - Your Comfort is Our Priority
      </h1>
      <p className='my-3'>
        {' '}
        At Bookme.rw, we take pride in providing exceptional customer service to
        ensure your hotel booking experience is smooth, delightful, and
        stress-free. Our dedicated customer support team is committed to
        assisting you at every step of your journey, from finding the perfect
        hotel to making sure your stay is nothing short of extraordinary. Your
        comfort and satisfaction are our top priorities, and we are here to make
      ...
      <p className='my-3'>
        Our commitment to serving you knows no bounds. Whether you have
        questions in the early hours of the morning or require assistance late
        at night, our customer service team is available 24/7 to cater to your
      ...
      <p className='my-3'>
        ...
        a crucial role in this process. Please let us know about your experience
        with <b>bookme.rw</b>, any suggestions you may have, or how we can
        further enhance your future journeys.
      </p>
      <p className='my-3'>
        At <b>Bookme.rw</b> we are committed to going the extra mile to ensure
        your satisfaction and make every moment of your travel experience
        extraordinary. Allow us to be your trusted partner in creating cherished
